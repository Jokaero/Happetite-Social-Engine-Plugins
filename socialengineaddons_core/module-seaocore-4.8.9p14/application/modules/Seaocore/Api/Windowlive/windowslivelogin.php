...
class WindowsLiveLogin
{
     ...
     */
    public static function initFromXml($settingsFile, $callback=null)
    {
       ...
       $settings['returnurl'] = ( _ENGINE_SSL ? 'https://' : 'http://' ) . $_SERVER['HTTP_HOST'] . Zend_Controller_Front::getInstance()->getBaseUrl() . '/' .Zend_Controller_Front::getInstance()->getRequest()->getModuleName() . '/usercontacts/getwindowlivecontacts?redirect_uri=' . $callback;
