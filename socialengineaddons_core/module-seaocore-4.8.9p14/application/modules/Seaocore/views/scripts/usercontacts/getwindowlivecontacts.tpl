 ...
 * @version    $Id: getwindowlivecontacts.tpl 2010-08-17 9:40:21Z SocialEngineAddOns $
...
if (!empty($this->addtononfriend)) { ?>
	<div class="seaocore_user_contacts">
		...
		<div class="seaocore_user_contacts_buttons">
			<?php if  (empty($this->moduletype)) : ?>		
			   <button name="invitefriends"  id="invitefriends" onclick="inviteFriends('windowlive');" style="float:left;margin-right:4px;"><?php echo $this->translate("Invite to Join");?></button>
			
			<?php else : ?>
			
			   <button name="invitefriends"  id="invitefriends" onclick="invitePreview('windowlive');" style="float:left;margin-right:4px;"><?php echo $this->translate("Invite to Join");?></button>	
			<?php endif ; ?>
