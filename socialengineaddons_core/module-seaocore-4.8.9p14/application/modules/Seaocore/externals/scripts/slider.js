...
var Slider = new Class({
    ...
    initialize: function(el, knob,bkg, options, maxknob) { 
		...
		if(maxknob != null) {
			...
			this.maxknob.setStyle('position', 'relative').setStyle(this.p, + this.max - this.options.offset).setStyle('bottom', 11);
		}
		var lim = {};
		//status = this.z
	...
	checkStep: function(mx){
		...
		if(this.maxknob!=null) {
			...
			mi = - this.options.offset; 
			//mx= parseInt(this.maxknob.getStyle('left')) - this.options.offset-4 ;
            mx= parseInt(this.maxknob.getStyle('left')) - this.options.offset+5 ;
            ...
            mi = parseInt(this.knob.getStyle('left'))-this.options.offset+8; 
			...
			this.clip_l = parseInt(this.knob.getStyle('left')) + 8;
