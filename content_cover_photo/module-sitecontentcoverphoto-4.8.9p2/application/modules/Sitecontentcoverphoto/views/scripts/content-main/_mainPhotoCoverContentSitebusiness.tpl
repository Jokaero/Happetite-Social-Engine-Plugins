...
<div class="seaocore_profile_cover_head_section_inner" id="seaocore_profile_cover_head_section_inner">
  ...
  <?php if(($this->profile_like_button == 1) || (in_array('followButton', $this->showContent)) || (in_array('joinButton', $this->showContent)) || (in_array('addButton', $this->showContent))):?>
    <div class="seaocore_profile_coverinfo_buttons">
      ...
      <?php if (is_array($this->showContent) && Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitebusinessmember')) : ?>
				...
				if (empty($joinMembers) && in_array('joinButton', $this->showContent) && $this->viewer->getIdentity() != $this->subject()->owner_id && Engine_Api::_()->sitebusiness()->allowInThisBusiness($this->subject(), "sitebusinessmember", 'smecreate')): ?>
					...
					<?php if ($this->viewer->getIdentity()) : ?>
						<?php if (!empty($this->subject()->member_approval)): ?>
							<a href="javascript:void(0);" onclick="Smoothbox.open('<?php echo $this->escape($this->url(array( 'action' => 'join', 'business_id' => $this->subject()->business_id), 'sitebusiness_profilebusinessmember', true)); ?>'); return false;" ><i class="plus_icon"></i><span><span><?php echo $this->translate("Join Business"); ?></span></a>
						<?php else: ?>
							<a href="javascript:void(0);" onclick="Smoothbox.open('<?php echo $this->escape($this->url(array( 'action' => 'request', 'business_id' => $this->subject()->business_id), 'sitebusiness_profilebusinessmember', true)); ?>'); return false;" ><i class="plus_icon"></i><span><span><?php echo $this->translate("Join Business"); ?></span></a>
						<?php endif; ?>
					<?php endif; ?>
					</div>
				<?php endif; ?>
        ...
        if (!empty($hasMembers) && in_array('leaveButton', $this->showContent) && $this->viewer->getIdentity() != $this->subject()->owner_id && Engine_Api::_()->sitebusiness()->allowInThisBusiness($this->subject(), "sitebusinessmember", 'smecreate')): ?>
					<div class="seaocore_button">
            <?php if ($this->viewer->getIdentity()) : ?>
              <a href="javascript:void(0);" onclick="Smoothbox.open('<?php echo $this->escape($this->url(array( 'action' => 'leave', 'business_id' => $this->subject()->business_id), 'sitebusiness_profilebusinessmember', true)); ?>'); return false;" ><i class="minus_icon"></i><span><?php echo $this->translate("Leave Business"); ?></span></a>
            <?php endif; ?>
					</div>
				<?php endif; ?>
				...
				<?php if (is_array($this->showContent) && in_array('addButton', $this->showContent)): ?>
					...
					<div>
						<a class="sitebusiness_button" href="javascript:void(0);" onclick="Smoothbox.open('<?php echo $this->escape($this->url(array( 'action' => 'invite-members', 'business_id' => $this->subject()->business_id), 'sitebusiness_profilebusinessmember', true)); ?>'); return false;" ><i class="add_people"></i><span><?php echo $this->translate("Add People"); ?></span></a>	
					</div>
