    ...
    <?php if (in_array('mainPhoto', $this->showContent) || in_array('title', $this->showContent) || in_array('category', $this->showContent)): ?>
        ...
        <?php if(in_array('badge', $this->showContent) && isset($this->sitebusinessbadges_value) && isset($this->sitebusinessbadge)):?>
					<?php if (empty($this->sitebusinessbadges_value) || $this->sitebusinessbadges_value == 2): ?>
						<?php $badgeTitle = $this->sitebusinessbadge->title; ?>
					<?php endif; ?>
              ...
              <a data-transition="pop" href="#profile_badges_<?php echo $this->sitebusinessbadge->badge_main_id?>" data-rel="popup"><img src="<?php echo $main_path ?>" class="fright" style="height:50px;width:50px;" /></a>
							<?php endif;?>
						<?php endif; ?>
					<?php endif; ?>
        <?php endif; ?>
					...
					<table cellpadding="2" cellspacing="0" style="width:100%">
						<tr>
							<?php if (in_array('sponsored', $this->showContent) && !empty($sitebusiness->sponsored)): ?>
								<td style="width:50%;">
									<div class="sm-sl" style='background: <?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sitebusiness.sponsored.color', '#fc0505'); ?>;'>
							...
							<td style="width:50%;">
								<div class="sm-sl" style='background: <?php echo Engine_Api::_()->getApi('settings', 'core')->getSetting('sitebusiness.featured.color', '#0cf523'); ?>;'>
          ...
          <div class="siteuser_cover_profile_fields">
						<ul>
								<li>
									...
									<span> <?php echo $this->htmlLink('https://maps.google.com/?q='.urlencode($sitebusiness->location), $sitebusiness->location, array('target' => 'blank')) ?> </span>
								</li>
            </ul>
          </div>
				<?php endif;?>
    ...
    <?php if (in_array('likeButton', $this->showContent) || in_array('followButton', $this->showContent) || in_array('joinButton', $this->showContent) || in_array('addButton', $this->showContent) || in_array('leaveButton', $this->showContent)): ?>
            ...
            <?php if(Engine_Api::_()->hasModuleBootstrap('sitebusinessmember') && !empty($this->viewer_id)):?>
              <?php if (in_array('joinButton', $this->showContent)):?>
                          ...
                          <span><?php echo $this->translate("Join Business"); ?></span>
												</a>
											</td>
										<?php else: ?>
											<td>
                          ...
                          <i class="ui-icon-ok"></i>
                          <span><?php echo $this->translate("Join Business"); ?></span></a>
											</td>
										<?php endif; ?>
									<?php endif; ?>
								<?php endif; ?>
              ...
              <?php endif; ?>
                    ...
                    <i class="ui-icon-delete"></i>
                    <span><?php echo $this->translate("Leave Business"); ?></span>
                  </a>
								<?php endif; ?>
							</td>
							<?php endif; ?>
