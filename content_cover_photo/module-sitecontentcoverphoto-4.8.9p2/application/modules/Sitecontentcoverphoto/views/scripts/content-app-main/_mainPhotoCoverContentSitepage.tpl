      ...
      <table cellpadding="2" cellspacing="0">
        <tr>
          ...
          <?php endif;?>
             ...
             <!--JOIN /LEAVE BUTTON WILL BE SHOWN ONLY IF SITEPAGE MEMBER EXIST HERE OTHERWISE DISPLAY MESSAGE & SHARE BUTTON-->                <?php if(Engine_Api::_()->hasModuleBootstrap('sitepagemember') && !empty($this->viewer_id)):?>   
             ...
             <?php else:?>
                <?php if($this->viewer_id && $this->can_share):?>
                  ...
                  <?php endif; ?>
                  <?php if ($sitepage->owner_id != $this->viewer_id && $this->viewer_id && $this->showMessageOwner != 'none'):?>
                  <td>
