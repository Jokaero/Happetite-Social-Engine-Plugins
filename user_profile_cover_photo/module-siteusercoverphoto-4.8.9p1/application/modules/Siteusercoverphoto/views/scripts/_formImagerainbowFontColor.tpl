  ...
  window.addEvent('domready', function() {
    ...
    var r = new MooRainbow('myRainbow1', {
      ...
      'onChange': function(color) {
        $('siteusercover_font_color').value = color.hex;
				//r.layout.setStyles({'position':'relative','clear':'both'});
				//r.show();
      }
    });
		$('siteusercover_font_color').value  = $('hiddenfontcolor').value;

    r.layout.inject($('siteusercover_font_color-wrapper'), 'before');
    r.layout.setStyles({'position':'relative','clear':'both'});
    r.show();
...
<div id="siteusercover_font_color-wrapper" class="form-wrapper">
	<input name="myRainbow1" id="myRainbow1" style="display:none;">
	<div id="siteusercover_font_color-label" class="form-label">
		<label for="siteusercover_font_color" class="optional">
			<?php //echo $this->translate("Edit Font Color");?>
		</label>
	</div>
	<div id="siteusercover_font_color-element" class="form-element">
		<p class="description"></p>
		<input name="siteusercover_font_color" id="siteusercover_font_color" type="text" value=""/>
	</div>
</div>
